...
<!-- 								<h2>Unconventional, Just How I Like It</h2>
 ...
 -->							</div>
							<div class="padB0-7">
								...
								<div class="btnGroup"><a href="#you" class="btn">Take the first step</a></div>
							</div>
						</div>
					</div>
				</section>
					...
					<div class="grid6 marginR1 fRight">
						...
						<div class="padB0-7">
							...
							<form id="youContact" name="youContact" action="<?php echo $_SERVER['SERVER_NAME']; ?>" role="form">
								...
								<input id="youName" name="youName" type="text" required aria-required="true" placeholder="Name" />
								<input id="youEmail" name="youEmail" type="text" required aria-required="true" placeholder="Email" />
					...
					<div id="skillsGrid" class="grid6 marginR1">
						...
						<div class="grid12 skills">
							<div class="grid6 padR1G">
								...
								<h3 class="grid12"><span class="label">UX/UI Principles</span>: Advanced</h3>
								<h3 class="grid12"><span class="label small">Responsive Design</span>: Advanced</h3>
								<h3 class="grid12"><span class="label small">Responsive Code</span>: Advanced</h3>
							</div>
							<div class="grid6">
								<h3 class="grid12"><span class="label">HTML5</span>: Expert</h3>
								...
								<h3 class="grid12"><span class="label">Git</span>: Knowledgeable</h3>
							</div>
						</div>
					</div>
				</div><!-- .wrap -->
			...
			<div class="wrap padT1">
				<section>
					...
					<div class="grid6 marginR1 details">
						<p>Executed full project process, including wireframe conception, detailed visualization, and coding of front-end (plus customization of, and integration with back-end software).</p>
						<p>Coded and debugged extensively in HTML, CSS (and SASS), PHP, Javascript, and jQuery, with a focus on customizing Content Management Systems for client usability.</p>
						<p>Designed and coded elegant, user-centric responsive websites.</p>
						<ul>
							<li>Used Photoshop and Sketch (with fluid grids) to design with breakpoints in mind.</li>
							<li>Coded using Twitter Bootstrap, Foundation, and a self-built responsive framework.</li>
						</ul>
						<p>Optimized performance and user experience of client and internal websites.</p>
						<p>Worked with SASS and Git as part of internal workflow.</p>
				...
				<section>
					...
					<div class="grid6 marginR1 details">
						...
						<ul>
							...
							<li>Chaired Team Leaders’ weekly meetings and updated Project Status Reports accordingly.</li>
						</ul>
					</div>
				</section>
...
<?php /*					<a href="http://instagram.com/LucasUnplugged/" class="inset"><i class="icon-instagram">&nbsp;</i></a> */ ?>
			...
			<section class="grid3 marginR1">
				...
				<form id="footContact" name="footContact" action="<?php echo $_SERVER['SERVER_NAME']; ?>" role="form">
					...
					<input id="footName" name="footName" type="text" required aria-required="true" placeholder="Name" />
					<input id="footEmail" name="footEmail" type="text" required aria-required="true" placeholder="Email" />
