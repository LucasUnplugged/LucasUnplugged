	...
	$.fn.extend({
		leanModal:function(options){
			...
			return this.each(function(){
				...
				$(this).keydown(function (e) { var modal_id=$(this).attr("href");var code=(e.keyCode ? e.keyCode : e.which);if(code==27){close_modal(modal_id);}else if(code==37){
					// $("a[rel*=leanModal]").each(function(){close_modal(modal_id);});$(this).prev("a[rel*=leanModal]").trigger("click");
				}else if(code==39){
					// $("a[rel*=leanModal]").each(function(){close_modal(modal_id);});$(this).next("a[rel*=leanModal]").trigger("click");
				} console.log(code); });
			});
